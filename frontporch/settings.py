...
ASTERISK_TTS_ENGINE_SIGNATURE = os.environ.get(
    ...
    "espeak-ng-1.51+dfsg-10+deb12u2_sox-14.4.2+git20190427-3.5",
)
ASTERISK_TTS_ESPEAK_COMMAND = os.environ.get(
    "ASTERISK_TTS_ESPEAK_COMMAND",
    "espeak-ng",
)
ASTERISK_TTS_SOX_COMMAND = os.environ.get("ASTERISK_TTS_SOX_COMMAND", "sox")
ASTERISK_TTS_VOICE = os.environ.get("ASTERISK_TTS_VOICE", "en-us")
ASTERISK_TTS_SPEED = int(os.environ.get("ASTERISK_TTS_SPEED", "145"))
ASTERISK_TTS_PITCH = int(os.environ.get("ASTERISK_TTS_PITCH", "50"))
ASTERISK_TTS_AMPLITUDE = int(os.environ.get("ASTERISK_TTS_AMPLITUDE", "100"))
